...
rows: [
{title: `⫹🗒️ › ${emot}〚 All Menu 〛-𐑂`, rowId: ".? all", description: "╰► Menampilkan Seluruh Command SasukeBotz"},
	...
	{title: `⫹☪️ › ${emot}〚 Islamic 〛-𐑂`, rowId: ".? quran", description: "╰► Tumben Banget..."},
	...
	{title: `⫹👩‍💻 › ${emot}〚 Owner 〛-𐑂`, rowId: ".? owner", description: "╰► Yg bukan developer SasukeBotz gausah nge klik fitur ini !"},
...
rows: [
{title: `🔖 ${emot} SEWA`, rowId: ".sewa", description: "Menampilkan list harga sewa ☸𝐒𝐚𝐧𝐳⚘𝐁𝐎𝐓𝐙࿐"},
...
┃▷ *Sᴛᴀᴛᴜs* : ${m.sender.split`@`[0] == nomorown ? 'Developer' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Free User')}
┃▷ *Pʀᴇᴍɪᴜᴍ* : ${usrs.premiumTime > 1 ? '☑️ Ya': '✘ Tidak'}
┃▷ *Rᴏʟᴇ* : ${usrs.role}
┃▷ *Lɪᴍɪᴛ* : ${usrs.limit}
┃▷ *Lᴇᴠᴇʟ* : ${usrs.limit}
╰╴╴╴╳
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    mediaType: 2, 
    description: sgc,
    title: "「 𝕠𝕗𝕗𝕚𝕔𝕚𝕒𝕝 」☸𝐒𝐚𝐧𝐳⚘𝐁𝐎𝐓𝐙࿐ 𝐁𝐨𝐭",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/7143629c7a36c2f460071.jpg')).buffer(),
    sourceUrl: sgc
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
