...
let handler = async (m, { conn, command, text }) => {
  ...
  let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/7143629c7a36c2f460071.jpg")
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        mediaType: 2,
                        description: `Create By RizkyEditz`,
                        title: global.nameown,
                        body: `Jangan Lupa Subs YT Owner`,          previewType: 0,
                        thumbnail: fs.readFileSync("./MenuAwal.jpg"),
                        mediaUrl: 'https://youtube.com/@☸𝐒𝐚𝐧𝐳⚘𝐁𝐎𝐓𝐙࿐'
